...
if ($_SERVER['PHP_SELF'] == '/inscription/projet/MVC/vues/subscribe.php') {
    header('Location: /inscription/projet/?page=subscribe');
}


?>

<section id="adminInsert">
    <span class="btnClose" onclick="masquerVideo()">&times;</span>
    <div class="container ">
        <div class="row row2">
            <div class="CardCss col-12">

            <form action="?page=admin&insertAdmin" method="POST" class="col-12 ">
