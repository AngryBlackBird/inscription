...
<section>
    <div class="container-fluid ">
        <div class="row mt-2 mb-2">
            ...
            <form enctype="multipart/form-data" action="?page=admin&insertMultiple" method="post" class="col-5"
                  style="display:flex; align-items: center;">
                <input type="hidden" name="MAX_FILE_SIZE" value="30000"/>
                <input name="userfile" type="file"/>
                <button type="submit" class="btn btn-primary  ml-1 mr-1">Ajouter plusieurs clients (csv avec point
                    virgule)
                </button>
            </form>
            <form class="col-3">
